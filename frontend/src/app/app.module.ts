...
const routes: Routes = [
  ...
  { path: 'realtime_sma_line_chart', component: RealTimeSMALineComponent},
...
/////////////////////////////////////////////////////////////////////////////////////
    ...
    AgmCoreModule.forRoot({apiKey: 'AIzaSyCRRngh14dHPoctF_T1ePbhJfV0lF1yH90'+ '&libraries=visualization'}),
    FormsModule,
    NgbModule,
    MatCheckboxModule
